from seo_tool.tools.sqlqueries import get_standard, get_average, query_list
from seo_tool.tools.google import trend_to_absolute
from pytrends.request import TrendReq
from pytrends import dailydata
from seo_tool.tools.guardian import get_guardian_articles
from seo_tool.tools.nytimes import get_nyt_articles
...
def find_standard_new(keyword):
    '''
    Find a keyword stored in the gvolume database that have similar search volume in google trends and calculates the average mothly
...
def get_google_new(keyword, from_date=None):
    ...
    if stdic:
        try: 
            ...
            print(e)
            return 'Google Trends has bloqued your request imposible to retrive the historical data (monthly realtive searches), try it after some minutes'
    else:
        return 'Google Trends has bloqued your request imposible to retrive the historical data (average monthly searches), try it after some minutes'
